...
INSERT INTO `nozama`.`product` (`id_product`, `date_released`,`name`,`description`,`url_picture`) VALUES (1,'Work','Le nouveau clip de Rihanna a été dévoilé ce lundi 22 février. Pour sa troisième collaboration avec le rappeur Drake, la chanteuse, a choisi de mettre l\'accent sur une musique inspirée de la dance-hall jamaïcaine. Dans une ambiance chaude, la princesse du R\'n\'B, qui a fêté ses 28 ans le 20 février, s\'illustre comme à son habitude par des pas de danse sexy et maîtrisés. Rihanna reste ainsi fidèle à ses origines caribéennes puisque l\'atmosphère du clip est directement venue des soirées barbadienne et le \"twerk\" y trouve largement sa place. Vêtue d\'une robe au couleur rouge, jaune et vert, l\'artiste surprend encore avec sa provocation réfléchie et accepté par des fans toujours plus nombreux.','Work.jpg');
INSERT INTO `nozama`.`product` (`id_product`, `date_released`,`name`,`description`,`url_picture`) VALUES (2,'Hundred Miles',NULL,'HundredMiles.jpg');
INSERT INTO `nozama`.`product` (`id_product`, `date_released`,`name`,`description`,`url_picture`) VALUES (3,'Les nouvelles aventures d\'Aladin','Une nouvelle histoire d\'Aladin à la conquête du coeur de sa belle demoiselle !','aladin.jpg');
INSERT INTO `nozama`.`product` (`id_product`, `date_released`,`name`,`description`,`url_picture`) VALUES (4,'Steak','Mr Oizo livre un OVNI déjanté avec Eric et Ramzy méconnaissables.','steak.jpg');
